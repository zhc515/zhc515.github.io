...
- [Directed reading program: From PDE to SDE](https://zhc515.github.io/teaching/2025-winter-teaching)

2/6 Introduction. Textbooks for PDE: Evans, Strauss.

2/13 ODE techniques(separation of variables, and integrating factors), introduction to PDEs(linear, non-linear), deriving fundamental solution of Laplace equation by ODE methods(Evans 2.2.1).

2/20 Solving Poisson equation by convolution with fundamental solution(Evans 2.2 THEOREM 1); Mean-value property of harmonic function(Evans 2.2 THEOREM 2 and 3).
